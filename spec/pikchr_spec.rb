...
describe Asciidoctor::Diagram::PikchrBlockMacroProcessor, :broken_on_github, :broken_on_windows do
  include_examples "block_macro", :pikchr, code, [:svg]
end

describe Asciidoctor::Diagram::PikchrBlockProcessor, :broken_on_github, :broken_on_windows do
