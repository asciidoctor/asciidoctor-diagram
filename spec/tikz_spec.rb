...
describe Asciidoctor::Diagram::TikZBlockMacroProcessor, :broken_on_github, :broken_on_windows do
  include_examples "block_macro", :tikz, code, [:pdf]
end

describe Asciidoctor::Diagram::TikZBlockProcessor, :broken_on_github, :broken_on_windows do
