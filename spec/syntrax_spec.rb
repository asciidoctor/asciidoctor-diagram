...
describe Asciidoctor::Diagram::SyntraxBlockMacroProcessor, :broken_on_windows, :broken_on_osx do
  include_examples "block_macro", :syntrax, SYNTRAX_CODE, [:png, :svg]
end

describe Asciidoctor::Diagram::SyntraxBlockProcessor, :broken_on_windows, :broken_on_osx do
