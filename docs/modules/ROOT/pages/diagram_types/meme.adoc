...
|height        |20%           |The height of the labels as a percentage of the total image height or an absolute height in pixels
|top-height    |same as height|The height of the top text
|bottom-height |same as height|The height of the bottom text
