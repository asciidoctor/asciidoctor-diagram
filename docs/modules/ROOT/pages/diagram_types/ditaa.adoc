...
A https://github.com/pepijnve/ditaa[fork of ditaa] is automatically available via the https://rubygems.org/gems/asciidoctor-diagram-ditaamini[asciidoctor-diagram-ditaamini] gem which contains the Ditaa jar.
