...
This implementation tries to be as compatible as possible with the AsciidoctorJ barcode extension.

----
barcode::codabar[A123456A]
----

The target of the block macro tells the extension which type of barcode is being requested.
The first positional attribute is the data that should be encoded in the barcode.
