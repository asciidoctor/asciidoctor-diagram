...
<type>::<content>[<attributes>]
------
<1> Type barcode type. One of `bookland`, `codabar`, `code_25`, `code_25_iata`, `code_25_interleaved`, `code_39`, `code_93`, `code_128`, `code_128a`, `code_128b`, `code_128c`, `ean_8`, `ean_13`, `gs1_128`, `pdf_417`, or `upc_a`.
<2> Barcode attributes (see the <<barcode_attributes>> attributes section)
<3> The content to encode in the barcode

By default the target field of the barcode macros will be interpreted as the barcode content.
