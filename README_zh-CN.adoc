...
:uri-tikz: https://tikzit.github.io/
...
扩展支持 BlockDiag （BlockDiag、SeqDiag、ActDiag、NwDiag）， Ditaa、GraphViz、Mermaid、PlantUML、Shaape、Tikz 和 WaveDrom 语法。
