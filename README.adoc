...
image:https://github.com/asciidoctor/asciidoctor-diagram/workflows/ci-linux/badge.svg?branch=master["Linux Build Status", link="https://travis-ci.org/asciidoctor/asciidoctor-diagram"]
