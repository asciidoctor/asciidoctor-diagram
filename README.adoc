...
image::images/asciidoctor-diagram-process.png[Asciidoctor Diagram process diagram,650,319]
...
image::images/asciidoctor-diagram-classes.png[Asciidoctor Diagram classes diagram]
